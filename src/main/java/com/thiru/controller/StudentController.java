...
public class StudentController {
	...
	public String createStudents(@RequestBody @Valid Student student) {
		log.info("POST /api/createstudents called with payload: {}", student);

		studentservice.createStudent(student);

		log.info("Students are created successfully: {}", student);
		return "Students are created successfully";
	}
	...
	public Optional<Student> getStudentById(@PathVariable int id) {
		...
		log.info("Fetched student: {}", student.orElse(null));
		return student;
	}
	 ...
	 * 
	 * import com.thiru.dto.ApiResponse; import com.thiru.entities.Student; 
	 * import  com.thiru.service.StudentService;
	 * 
	 * @RestController
	 * 
 ...
 public ResponseEntity<ApiResponse>createStudent(@RequestBody Student student) {
	 ...
	 * ApiResponse response = new ApiResponse("Student created successfully", createdStudent);
	 ...
	 *  { 
	 *  log.info("Fetched student: {}", student.get());
	 ...
	 * // GET all students
	 * 
	 * @GetMapping("/fetchstudents") public ResponseEntity<List<Student>>getAllStudents(){
	 *  log.info("GET /api/fetchstudents called");
	 * 
	 * List<Student> students = studentservice.getAllStudents();
	 * 
	 * if (students.isEmpty()) 
	 * { 
	 * log.info("No students found"); return new
	 ...
	 * 
	 * @GetMapping("/fetchBranchAndName/{regNumber}")
	 *  public ResponseEntity<String determineBranchAndName(@PathVariable String regNumber)
	 *   {
	 ...
	 * 
	 * log.info("Student with ID {} updated successfully", id);
	 *   ApiResponse response = new ApiResponse("Student updated successfully", updatedStudent); 
	 * return new ResponseEntity<>(response, HttpStatus.OK); // 200 
	 * }
	 * 
	 * // UPDATE partial
	 * 
	 * @PatchMapping("/student/{id}") public ResponseEntity<ApiResponse>updateStudentPartially(@PathVariable int id, @RequestBody Student student)
	 *  {
	 ...
	 * 
	 * log.info("Student with ID {} partially updated successfully", id);
	 * ApiResponse response = new ApiResponse("Student partially updated successfully", updatedStudent); 
	 ...
	 * // DELETE
	 * 
	 * @DeleteMapping("/student/{id}") public ResponseEntity<String>deleteStudentById(@PathVariable int id)
	 *  {
